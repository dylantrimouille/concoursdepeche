            ...
            <div class="col">
                <div class="card h-80 shadow-sm"> <img src="/assets/img/affiche-concours.png" class="card-img-top"
                    ...
                    <div class="card-body">
                        ...
                        <div class="text-center my-4"> <button class="btn btn-secondary">Résultat à venir</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col">
                <div class="card h-80 shadow-sm"> <img src="/assets/img/affiche-concours.png" class="card-img-top"
                    ...
                    <div class="card-body">
                        ...
                        <div class="text-center my-4"> <a href="#" class="btn btn-warning">Infos & Réservations</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col">
                <div class="card h-80 shadow-sm"> <img src="/assets/img/affiche-concours.png" class="card-img-top"
                    ...
                    <div class="card-body">
                        ...
                        <div class="text-center my-4"> <a href="results-ctrl.php" class="btn btn-success">Résultats</a>
                        </div>
                    </div>
                </div>
            </div>
